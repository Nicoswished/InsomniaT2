...
public class Ranks {
    ...
    public enum Rangos{
        ...
        ADMIN(c("<GRADIENT:f12711>Admin </GRADIENT:f5af19>"), "01"),
        DEV(c("<GRADIENT:00c6ff>Developer </GRADIENT:0072ff>"), "02"),
        HOST(c("<GRADIENT:ff9a9e>Host </GRADIENT:fad0c4>"), "03"),
        MOD(c("<GRADIENT:8E2DE2>Moderador </GRADIENT:4A00E0>"), "04"),
        USER(c("<GRADIENT:11998e>Miembro </GRADIENT:38ef7d>"), "05");
